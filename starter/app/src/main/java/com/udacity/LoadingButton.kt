...
class LoadingButton @JvmOverloads constructor(
    ...
    private var customButtonText = "Download"
    ...
    private var buttonState: ButtonState by Delegates.observable(ButtonState.Completed) { _, _, state ->
        ...
        when(state){
            ButtonState.Clicked -> {
                ...
                customButtonText = context.getString(R.string.button_name)
            }
            ButtonState.Loading -> {
                ...
                downloading = true
                custom_button.isClickable = false
                customButtonText = context.getString(R.string.button_loading)
                invalidate()
            }
    ...
    init {
        ...
        context.withStyledAttributes(attrs, R.styleable.LoadingButton) {
            loadButtonBackgroundColor = getColor(R.styleable.LoadingButton_normalColor, 0)
            loadButtonTextColor = getColor(R.styleable.LoadingButton_textColor, 0)
        }
    }
